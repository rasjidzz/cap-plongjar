...
class IntegrationTestKapKur extends TestCase
{
    ...
    public function test_kaprodi_plots_solo_with_jabatan_and_kaur_lab_views_results(): void
    {
        ...
        $kaurLabViewResponse = $this->actingAs($kaurLabUser, 'sanctum')->getJson(
            '/api/v1/plottingan-pengajaran/tahun-ajaran/' . $tahunAjaran->id . '/program-studi/' . $programStudiKaprodi->id
        );

        $kaurLabViewResponse->assertStatus(200)
                        ->assertJson([
                            'success' => true,
    ...
    /**
     * Test Integrasi: Kaprodi memplot dosen (Solo Teaching, tanpa Jabatan Struktural) dan Kaur Lab melihat hasilnya.
     *
     * @return void
     */
    public function test_kaprodi_plots_solo_no_jabatan_and_kaur_lab_views_results(): void
    {
        // 1. Persiapan Data
        ...
        // 4. Assert Kaur Lab view berhasil dan data sesuai
        $kaurLabViewResponse->assertStatus(200)
                        ->assertJson([
                            'success' => true,
                            'message' => 'Hasil Plottingan Pengajaran untuk Program Studi "' . $programStudiKaprodi->nama . '" pada Tahun Ajaran "' . $tahunAjaran->tahun_ajaran . ' - ' . $tahunAjaran->semester . '" berhasil dimuat.',
                        ]);
        $kaurLabViewResponse->assertJsonCount(1, 'data.data');
        $kaurLabViewResponse->assertJsonFragment([
    ...
    /**
     * Test Integrasi: Kaprodi memplot dosen (Team Teaching, dengan Jabatan Struktural) dan Kaur Lab melihat hasilnya.
     *
     * @return void
     */
    public function test_kaprodi_plots_team_with_jabatan_and_kaur_lab_views_results(): void
    {
        // 1. Persiapan Data
    ...
    /**
     * Test Integrasi: Kaprodi memplot dosen (Team Teaching, tanpa Jabatan Struktural) dan Kaur Lab melihat hasilnya.
     *
     * @return void
     */
    public function test_kaprodi_plots_team_no_jabatan_and_kaur_lab_views_results(): void
    {
        // 1. Persiapan Data
